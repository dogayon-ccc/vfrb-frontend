// src/pages/admin/QCChecklist.jsx
...
const lbl = {
  ...
  textTransform: 'uppercase', letterSpacing: '.07em', color: '#64748b', marginBottom: 7,
  fontFamily: FONT,
};

// QC checklist items — from Ma'am Fe's interview (Apr 30 2026)
const CHECKS = [
  { key: 'stitching_ok', label: 'Stitching',   icon: '🧵', desc: 'Uniform, secure, no loose threads' },
  { key: 'color_ok',     label: 'Color Match',  icon: '🎨', desc: 'Matches color specified in order + PO swatch' },
  { key: 'size_ok',      label: 'Size / Fit',   icon: '📏', desc: 'Measurements match spec sheet per size' },
  { key: 'label_ok',     label: 'Labels',       icon: '🏷️', desc: 'Size + brand labels correctly attached' },
  { key: 'finish_ok',    label: 'Finish',       icon: '✨', desc: 'No raw edges, clean pressing, no stains' },
  { key: 'button_ok',    label: 'Buttons/Zip',  icon: '🔘', desc: 'All fasteners functional', optional: true },
];
...
function calc8020(itemsChecked, itemsPassed) {
  ...
  return {
    ...
    color:       clears ? '#166534' : '#991b1b',
    bgColor:     clears ? '#f0fdf4' : '#fef2f2',
    borderColor: clears ? '#bbf7d0' : '#fecaca',
  };
}
...
function CheckRow({ item, value, onChange }) {
  ...
  return (
    <div style={{
      ...
      background: isPassed ? '#f0fdf4' : isFailed ? '#fef2f2' : '#f8fafc',
      border: `1px solid ${isPassed ? '#bbf7d0' : isFailed ? '#fecaca' : '#e2e8f0'}`,
      transition: 'all .15s',
    }}>
      {/* Icon */}
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
          ...
          {item.optional && (
            <span style={{ fontSize: 10, color: '#94a3b8', fontWeight: 400 }}>optional</span>
          )}
      ...
      <div style={{ display: 'flex', gap: 6, flexShrink: 0, alignSelf: 'center' }}>
        <button
          ...
          style={{
            ...
            background: isPassed ? '#22c55e' : '#f1f5f9',
        ...
        <button
          ...
          style={{
            ...
            fontFamily: FONT,
            fontSize: 12, fontWeight: 700, minHeight: 36,
            background: isFailed ? '#ef4444' : '#f1f5f9',
            color:      isFailed ? '#fff'    : '#64748b',
            transition: 'all .13s',
          }}
        >
          ✗ Fail
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <h3 style={{ fontSize: 15, fontWeight: 800, color: '#0f172a', margin: '3px 0 0' }}>
        ...
        <div style={{
          ...
          background: '#f0fdfa', color: T, border: `1px solid ${T}30`,
        }}>
          80/20 QC Rule
        </div>
      </div>
      ...
      {existing && (
        <div style={{
          ...
          background: existing.passed ? '#f0fdf4' : '#fef2f2',
          border: `1px solid ${existing.passed ? '#bbf7d0' : '#fecaca'}`,
        }}>
          <p style={{ fontSize: 12, fontWeight: 700, margin: 0, color: existing.passed ? '#166534' : '#991b1b' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
              {CHECKS.filter(c => checks[c.key] === false).map(c => (
                <span key={c.key} style={{
                  ...
                  background: '#fff', border: `1px solid ${T}30`, color: T,
                }}>
                  {c.icon} {c.label}
                </span>
              ))}
      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10 }}>
          {[
            ['items_checked', 'Pieces Inspected', '#0f172a'],
            ['items_passed',  'Passed',           '#22c55e'],
            ...
            <div key={k}>
              ...
              <input
                ...
                style={{
                  ...inp,
                  textAlign: 'center',
                  borderColor: k === 'items_checked' ? '#e2e8f0' : `${color}40`,
                  background: k === 'items_failed' ? '#f8fafc' : '#fff',
            ...
            <div style={{ marginBottom: 10 }}>
              ...
              <div style={{ position: 'relative', height: 8, marginTop: -8, pointerEvents: 'none' }}>
                <div style={{
                  ...
                  width: 2, height: 8, background: '#94a3b8', borderRadius: 1,
                }}/>
              </div>
            </div>
      ...
      {err && (
        <p style={{ color: '#ef4444', fontSize: 12, fontWeight: 600 }}>⚠️ {err}</p>
      )}
      ...
      <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
        ...
        <motion.button
          ...
          style={{
            ...
            fontFamily: FONT,
            color: '#fff',
            background: (saving || !allAnswered) ? '#94a3b8'
              : willPass
      ...
      {done && (
        <motion.div
          ...
          style={{
            ...
            background: done.passed ? '#f0fdf4' : '#fef2f2',
            border: `1px solid ${done.passed ? '#bbf7d0' : '#fecaca'}`,
          }}
        >
          <p style={{
            fontSize: 14, fontWeight: 800, margin: 0,
            color: done.passed ? '#166534' : '#991b1b',
          }}>
            {done.passed
      ...
      >
        ...
        <div style={{
          ...
          {loading ? (
            ...
            <div style={{ padding: '20px', textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 12, color: '#64748b' }}>No orders in QC stage</p>
            </div>
          ) : (
            orders.map(o => (
              <button
                ...
                style={{
                  ...
                  background: selId === String(o.order_id) ? '#f0fdfa' : '#f8fafc',
        ...
        {selOrder ? (
          ...
          <div style={{
            ...
            <p style={{ color: '#64748b', fontSize: 13 }}>Select an order to begin QC</p>
          </div>
        )}
      </div>
    </>
