...
// DESIGN SYSTEM MIGRATION (this pass) — presentation layer only.
// State, API calls, validation, and the BUG-4 responsive grid fix below
// are UNCHANGED from the previous version — only the markup now goes
// through the shared Card / Button / Field / Badge / NavIcon components
// in src/components/ui/ instead of four separately hand-rolled inline
// "card" style blocks and emoji-as-icons. See src/components/ui/Card.jsx
// for why: the .card CSS class already existed in main.css and was used
// nowhere in the app before this file.
//
// FIXES CARRIED OVER FROM PRIOR VERSION (still true, still enforced):
//   1. CDN font removed — system font stack (now var(--font-sans) via
//      body{}, this file no longer needs its own FONT constant at all)
//   2. BUG 4: responsive grid — single column always on mobile, 2-col
//      tablet/desktop via .profile-grid / .profile-field-row
//   3. All buttons: min-height 44px (Button component's size="md")
//   4. Success/error messages: AnimatePresence slide-in (Toast, unchanged)
//   5. Avatar card responsive stack on ≤400px (.profile-avatar-card)
    ...
    <div style={{ position: 'relative' }}>
      ...
      <button
        ...
        style={{
          ...
          color: 'var(--color-faint)', display: 'flex',
        }}>
...
export default function CustomerProfile() {
  ...
  return (
    <>
      <style>{`
        /* BUG 4 FIX: responsive profile layout — unchanged from prior version */
        .profile-grid {
          display: grid;
      ...
      <div style={{ width: '100%' }}>
        ...
        <div style={{ marginBottom: 22 }}>
          <h1 style={{ fontSize: 'clamp(18px,3vw,22px)', fontWeight: 800, color: 'var(--color-text)', margin: '0 0 4px' }}>
            Profile
          </h1>
            ...
            <Card padding="sm">
              <div className="profile-avatar-card" style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  <p style={{
                    fontSize: 16, fontWeight: 800, color: 'var(--color-text)', margin: 0,
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                {pwForm.password.length > 0 && (
                  <div style={{ display: 'flex', gap: 4 }}>
                    ...
                    <span style={{ fontSize: 9, color: 'var(--color-muted)', marginLeft: 4, alignSelf: 'center', whiteSpace: 'nowrap' }}>
            ...
            <Card tone="subtle" padding="sm">
              <p style={{
                ...
                fontSize: 12, fontWeight: 700, color: 'var(--color-text)', margin: '0 0 8px',
              }}>
                <NavIcon name="lock" size={13} />
                Data Privacy (RA 10173)
              </p>
              <p style={{ fontSize: 11, color: 'var(--color-muted)', lineHeight: 1.7, margin: 0 }}>
            ...
            {/* Account actions */}
            <Card padding="sm">
              <p style={{ fontSize: 12, fontWeight: 700, color: 'var(--color-text)', margin: '0 0 12px' }}>
                Account
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ fontSize: 12, color: 'var(--color-muted)' }}>Email verified:</span>
